...
export function usePageTransitions() {
  ...
  /**
   * Triggers the animation to hide the page, with the specified flow type.
   *
   ...
   *
   * @param {FlowType} [flowType] - The flow direction (`Next` or `Previous`). Only applicable to directional animations.
   * @returns {Promise<void>} A promise that resolves when the animation completes.
   */
  function hide(flowType: FlowType = FlowType.Next) {
